...
<head>
    ...
    <!-- Bootstrap -->
    <link href="/roundtable/include/Custom/nomalize.css" rel="stylesheet">
    <link href="/roundtable/include/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <style>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar-scroll">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="/roundtable/include/img/logo.png" alt="9PixelStudio"> </a>
                </div>
...
<script src="/roundtable/include/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>